        ...
        @if ($usesAlpine)
            <div class="{{ $breakpoint->menuToggleClasses() }}">
                <button
                    ...
                    aria-label="{{ __('capell-frontend::generic.open_menu') }}"
                    aria-controls="main-menu"
                    x-bind:aria-label="isMenuOpen ? '{{ __('capell-frontend::generic.close_menu') }}' : '{{ __('capell-frontend::generic.open_menu') }}'"
