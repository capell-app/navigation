...
it('removes the site name suffix from page navigation labels', function (): void {
    ...
    expect(NavigationCreator::getPageNavigationLabel($page, $language))
        ->toBe('A practical brief for a shared workshop');
});
