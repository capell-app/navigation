...
use Capell\ContentBlocks\Filament\Components\Forms\AssetsRepeater;
use Capell\ContentBlocks\Filament\Components\Forms\Content\DetailsSchema;
use Capell\ContentBlocks\Filament\Components\Forms\Content\RelatedRepeater;
...
class HeroContentBlockConfigurator extends DefaultContentBlockConfigurator
{
    ...
    protected function getAssetsComponent(Schema $configurator): AssetsRepeater
    {
        return AssetsRepeater::make('assets')
            ->compactRepeater()
            ->hiddenLabel()
            ->hint(__('capell-content-blocks::generic.widget_assets_repeater_hint'));
    }
}
