...
class AssetsRepeater extends Repeater
{
            ...
            ->extraItemActions([
                Action::make('edit_asset')
                    ...
                    ->tooltip(function (array $arguments, Repeater $component): ?string {
                        ...
                        return __(
                            'capell-content-blocks::button.edit_asset_type',
    ...
    protected static function getFormSchema(): array
    {
        ...
        return [
            ...
            $select
                ->label(__('capell-content-blocks::form.select_add_asset_type'))
                ->required()
                ->searchable()
                ->relationship(
                    'asset',
                ...
                ->createOptionUsing(function (Select $component, Schema $configurator, Get $get, array $data) use ($createOptionUsing): int|string {
                    ...
                    Notification::make()
                        ->title(__('capell-content-blocks::message.page_created_successfully'))
                        ->body($record->name)
                        ->send();
