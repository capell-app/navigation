...
class ContentBlocksTable implements TableConfigurator
{
    ...
    protected static function getTableColumns(): array
    {
        return [
            ...
            TextColumn::make('children_count')
                ->label(__('capell-content-blocks::table.children'))
                ->alignCenter()
                ->numeric()
                ->sortable()
                ->toggleable()
            ...
            BadgeableColumn::make('assets_count')
                ->label(__('capell-content-blocks::table.assets'))
                ->alignCenter()
                ->numeric()
                ->sortable()
                ->toggleable()
            ...
            DateColumn::make('visible_from')
                ->label(__('capell-content-blocks::table.visible_from'))
                ->toggleable(isToggledHiddenByDefault: true),
            DateColumn::make('visible_until')
                ->label(__('capell-content-blocks::table.visible_until'))
                ->toggleable(isToggledHiddenByDefault: true),
    ...
    protected static function getTableFilters(): array
    {
        return [
                ...
                ->schema([
                    ...
                    Select::make('parent_id')
                        ...
                        ->options(function (HasTable $livewire, Get $get): array {
                            ...
                            return $content_blocks->mapWithKeys(function (ContentBlock $content_block) use ($siteId): array {
                                $label = '';
            ...
            SelectFilter::make('publish_status')
                ->label(__('capell-content-blocks::table.publish_status'))
