...
namespace Capell\ContentBlocks\Filament\Resources\ContentBlocks\RelationManagers;
...
use Capell\ContentBlocks\Filament\Concerns\HasAssetsRelationManager;
...
class ContentBlockAssetsRelationManager extends RelationManager
{
        ...
        return $table
            ...
            ->filters([
                ...
                SelectFilter::make('type_id')
                    ...
                    ->options(fn (): array => ContentBlock::getTypes()),
            ])
            ->headerActions([
