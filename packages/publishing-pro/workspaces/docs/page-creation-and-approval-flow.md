...
npx -y -p @mermaid-js/mermaid-cli mmdc \
  -i packages/publishing-pro/workspaces/docs/images/page-creation-flow.mmd \
  -o packages/publishing-pro/workspaces/docs/images/page-creation-flow.svg \
  -b transparent

npx -y -p @mermaid-js/mermaid-cli mmdc \
  -i packages/publishing-pro/workspaces/docs/images/approval-example.mmd \
  -o packages/publishing-pro/workspaces/docs/images/approval-example.svg \
  -b transparent
```
